...
%----------------------------------------------------------------------------------------
\begin{rSection}{项目经历}
	\begin{rSubsection}{中兴通讯股份有限公司}{2023 年 7 月 - 至今}{嵌入式软件开}{陕西西安}
		\item 负责 ZM9300 模组中的定位服务, 基于 HD8040D 和 BG1101 芯片扩展 GPSD 开源代码.
		\item 负责维护 GNSS 模块的现有代码并做功能扩展, 开发 SDK 及测试用例, 维护客诉和修复 BUG 200 余项.
		\item 负责维护 ZM9300 模组中的时间同步服务, 适配 chronyd 源码, 基于自研芯片适配 gPTP 协议栈, 外场测试结果 offset 指标与高通相当.
		\item 基于自研芯片适配 bootchard, 首次在 S1 平台实现开机流程可视化, 为后续系统启动性能优化提供了数据基础和技术手段.
	\end{rSubsection}
	%------------------------------------------------
	\begin{rSubsection}{中国重型机械研究院股份公司}{2021 年 9 月 - 2022 年 5 月}{后端开发工程师}{陕西西安}
		\item 设计并实现基于 Spring Boot 的连铸智能工艺仿真软件包, 模拟连铸生产过程中的关键工艺流程, 为工艺优化与决策支持提供了可视化、可配置的仿真平台.
...
\begin{rSection}{专业技能}
	\begin{rSubsection}{}{}{}{}
		\item 熟悉常见的数据结构与算法, 熟悉基本的操作系统知识, 具备良好的业务理解能力.
		...
		\item 熟悉 Git、Shell 脚本、GCC、GDB、 Makefile 及 Yocto 等常用开发与构建工具.
	\end{rSubsection}
\end{rSection}
